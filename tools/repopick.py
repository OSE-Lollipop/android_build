...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
    ...
    patches from OSE's Gerrit instance.
...
if args.topic:
    url = 'http://gerrit.ose.net/changes/?q=topic:%s' % args.topic
    if args.verbose:
...
for change in args.change_number:
    ...
    #   )]}'
    #   [ ... valid JSON ... ]
    url = 'https://gerrit.ose.net/changes/?q=%s&o=CURRENT_REVISION&o=CURRENT_COMMIT&pp=0' % change
    if args.verbose:
